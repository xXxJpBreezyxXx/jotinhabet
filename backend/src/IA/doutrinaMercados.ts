...
ESCOPO — TUDO acima vale para SUREBET (arbitragem entre casas, onde o lucro é garantido e um mercado 3-vias ou um cruzamento A×B transforma o lucro garantido em prejuízo garantido). Em operação de PROMOÇÃO (freebet SNR, aposta qualificativa, cashback, "aposte e ganhe", múltipla qualificadora) estas restrições NÃO se aplicam: ali o objetivo é cumprir o regulamento e cobrir a exposição, o resultado não é lucro garantido e o mercado é escolhido pelo regulamento da casa (1X2 no futebol é normal numa qualificativa). Nesses casos: NÃO bloqueie por mercado proibido nem por grupo de W.O.; apenas avise o risco residual quando ele for material (ex.: no tênis, abandono pode anular a perna qualificadora e deixar a cobertura exposta — o prejuízo se limita à exposição da cobertura, não é red garantido).`;
